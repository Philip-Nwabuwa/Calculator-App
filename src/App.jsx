...
const App = () => {
  ...
  return (
    <main
      className="flex flex-col h-full h-screen items-center text-4xl font-bold bg-[#3a4764]"
    >
        <div className="flex flex-1 flex-col border-blue-200 bg-[#3a4764] rounded-xl justify-center mt-3 py-6 px-3 w-full max-w-lg">
